  ...
  return (
    <LegalChrome
      ...
      sections={[
        ...
        { id: '2-principi-che-seguiamo', label: 'Principi che seguiamo' },
        { id: '3-i-tuoi-diritti', label: 'I tuoi diritti' },
        {
          id: '4-come-esercitare-i-diritti',
          label: 'Come esercitare i diritti',
        },
        {
          id: '5-reclamo-all-autorita-di-controllo',
          label: 'Reclamo all’Autorità di controllo',
        },
        { id: '6-responsabili-e-sicurezza', label: 'Responsabili e sicurezza' },
        { id: '7-documenti-collegati', label: 'Documenti collegati' },
      ]}
    >
      ...
      <p>
        ...
        {COMPANY.address.full}. Per ogni richiesta in materia di dati personali puoi scrivere a{' '}
        <a href={`mailto:${COMPANY.privacyEmail}`}>{COMPANY.privacyEmail}</a>.
      </p>

      <h2 id="2-principi-che-seguiamo">2. Principi che seguiamo</h2>
      <p>
        Trattiamo i dati personali in modo lecito, corretto e trasparente, raccogliendo solo i dati
        necessari per le finalità dichiarate (minimizzazione), conservandoli per il tempo
        strettamente necessario e proteggendoli con misure di sicurezza adeguate.
      </p>

      <h2 id="3-i-tuoi-diritti">3. I tuoi diritti</h2>
      ...
      <ul>
        ...
        <li>
          <strong>Revoca del consenso (art. 7):</strong> revocare in qualsiasi momento il consenso
          prestato, senza pregiudicare la liceità del trattamento precedente.
        </li>
      </ul>

      <h2 id="4-come-esercitare-i-diritti">4. Come esercitare i diritti</h2>
      <p>
        ...
        diritto che intendi esercitare. Risponderemo senza ingiustificato ritardo e comunque entro{' '}
        <strong>30 giorni</strong>, salvo proroghe consentite per richieste complesse. Per tutelare
        i tuoi dati, potremmo chiederti di confermare la tua identità.
      </p>

      <h2 id="5-reclamo-all-autorita-di-controllo">5. Reclamo all’Autorità di controllo</h2>
      <p>
      ...
      <h2 id="6-responsabili-e-sicurezza">6. Responsabili e sicurezza</h2>
      <p>
        I fornitori che trattano dati per nostro conto (hosting, pagamenti, email) sono nominati
        responsabili del trattamento e vincolati al rispetto del GDPR. Adottiamo misure tecniche e
        organizzative adeguate a proteggere i dati.
      </p>

      <h2 id="7-documenti-collegati">7. Documenti collegati</h2>
      <p>
