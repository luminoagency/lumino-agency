...
export default function PrivacyPolicyPage() {
  return (
    <LegalChrome
      ...
      sections={[
        { id: '1-titolare-del-trattamento', label: 'Titolare del trattamento' },
        { id: '2-quali-dati-raccogliamo', label: 'Quali dati raccogliamo' },
        {
          id: '3-perche-trattiamo-i-dati-e-su-quale-base-gi',
          label: 'Perché trattiamo i dati e su quale base giuridica',
        },
        { id: '4-come-condividiamo-i-dati', label: 'Come condividiamo i dati' },
        { id: '5-trasferimenti-extra-ue', label: 'Trasferimenti extra UE' },
        {
          id: '6-per-quanto-tempo-conserviamo-i-dati',
          label: 'Per quanto tempo conserviamo i dati',
        },
        { id: '7-i-tuoi-diritti', label: 'I tuoi diritti' },
        { id: '8-sicurezza', label: 'Sicurezza' },
        { id: '9-modifiche', label: 'Modifiche' },
      ]}
    >
      <h2 id="1-titolare-del-trattamento">1. Titolare del trattamento</h2>
      <p>
        Il titolare del trattamento dei dati è <strong>{COMPANY.legalName}</strong> (Company No.{' '}
        {COMPANY.companyNumber}), società titolare del brand «{COMPANY.brand}» (di seguito «
      ...
      <h2 id="2-quali-dati-raccogliamo">2. Quali dati raccogliamo</h2>
      ...
      <ul>
        ...
        <li>
          <strong>Dati relativi all’ordine e al pagamento:</strong> piano scelto, importi, stato del
          pagamento. I dati della carta sono trattati direttamente dal fornitore di pagamenti e non
          sono da noi conservati.
        </li>
        <li>
      ...
      <h2 id="3-perche-trattiamo-i-dati-e-su-quale-base-gi">
      ...
      <h2 id="4-come-condividiamo-i-dati">4. Come condividiamo i dati</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          il fornitore dei pagamenti ({COMPANY.paymentProvider}) per gestire le transazioni in modo
          sicuro;
        </li>
      ...
      <h2 id="5-trasferimenti-extra-ue">5. Trasferimenti extra UE</h2>
      <p>
      ...
      <h2 id="6-per-quanto-tempo-conserviamo-i-dati">6. Per quanto tempo conserviamo i dati</h2>
      <p>
        Conserviamo i dati per il tempo necessario alle finalità indicate: i dati dell’account per
        la durata del rapporto e, successivamente, nei limiti degli obblighi legali e fiscali (di
        norma 10 anni per i documenti contabili). I dati trattati su consenso sono conservati fino
        alla revoca dello stesso.
      </p>

      <h2 id="7-i-tuoi-diritti">7. I tuoi diritti</h2>
      <p>
      ...
      <h2 id="8-sicurezza">8. Sicurezza</h2>
      <p>
        Adottiamo misure tecniche e organizzative adeguate per proteggere i dati da accessi non
        autorizzati, perdita o uso improprio, tra cui cifratura delle password, connessioni protette
        (HTTPS) e accessi controllati.
      </p>

      <h2 id="9-modifiche">9. Modifiche</h2>
      <p>
